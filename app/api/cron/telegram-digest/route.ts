...
import { sendInactivityNudges, sendMorningDigest, sendSponsorshipSignals } from '@/lib/server/telegram-notifications';
...
// One daily sweep covering four related, non-urgent background jobs - the morning digest
// (TASK-3.2.2), the long-inactivity nudge (TASK-3.2.3), post-performance metrics collection, and
// the sponsorship growth signal (TASK-5.4.3). Kept on one route/cron entry deliberately:
