...
Status: [x] zaimplementowane → [x] testy napisane i zielone → [x] zweryfikowane (tsc, build czyste) → [ ] zamknięte (PR w przygotowaniu) → [ ] weryfikacja żywego cotygodniowego check-inu przez prawdziwego bota (wymaga tygodnia realnego użycia)
