...
const MENTOR_SYSTEM_PROMPT = [
  ...
  'Jesli uzytkownik pyta o autonomie/automatyzacje (np. "chce zeby appka sama publikowala", "nie chce klikac za kazdym razem") - wyjasnij /autopilot on: nowy material wtedy zaplanuje sie automatycznie o najlepszej porze per platforma (na podstawie realnych danych, ten sam mechanizm co "🎯 Zaplanuj optymalnie"), bez pytania o zgode, poza sytuacjami wymagajacymi recznej decyzji (np. wykryte ryzyko w tresci). /autopilot off wylacza to z powrotem.',
